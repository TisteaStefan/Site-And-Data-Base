        ...
        <section>
            <div class="container">
                <div class="row mb-20 mt-30">
                    <div class="col-lg-6">
                        <h3 class="text-uppercase">Detalii despre autor</h3>
                        <div class="row">
                            <div class="col-lg-12 pt-5 mt-5">
                                <h3> Nume Prenume: Tistea Stefan </h3>
                                <h3> UPB FILS CTI-FR </h3>
                                <h3> 1210FB Iot</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <h3 class="text-uppercase">Contactați-ne</h3>
                        <p>Completați formularul de mai jos pentru a intra în contact cu noi.</p>
                        <div class="m-t-30">
                            <form class="widget-contact-form" novalidate action="insert.php" role="form"
                                method="post">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="name">Nume</label>
                                        <input type="text" aria-required="true" name="name" required
                                            class="form-control required name" placeholder="Introduceți numele">
                                    </div>
                                    <div class="form-group col-md-6">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="subject" required
                                            class="form-control required" placeholder="Subiect...">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="message" required rows="5"
                                        ...
                                        placeholder="Introduceți mesajul dumneavoastră"></textarea>
                                </div>
                                <button class="btn" type="submit" id="form-submit"><i
                                        class="fa fa-paper-plane"></i>&nbsp;Trimite mesaj</button>
                            </form>
                        </div>
                    </div>
                </div>
